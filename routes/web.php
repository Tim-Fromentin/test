...
Route::middleware(['auth', 'admin', 'throttle:25,1'])->group(function () {
    Route::get('/seller/create', [SellerController::class, 'create'])->name('sellers.create');
...
Route::middleware(['auth', 'throttle:25,1'])->group(function () {
    ...
    Route::put('categories/{productCategory:product_categorie_id}', [CategoriesController::class, 'destroy'])->name('categories.destroy');
